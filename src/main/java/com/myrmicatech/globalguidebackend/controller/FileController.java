...
import com.myrmicatech.globalguidebackend.payload.UploadFileResponse;
...
public class FileController {
    ...
    public List<UploadFileResponse> listAllFiles() {
        return fileStorageService.loadAll()
                .map(path -> new UploadFileResponse(path.getFileName().toString(), ServletUriComponentsBuilder
                        .fromCurrentContextPath().path("/downloadFile/").path(path.getFileName().toString()).toUriString())
